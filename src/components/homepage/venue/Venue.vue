...
<template>
  ...
  <el-row :gutter="24">
    <el-col v-for="venue in props.venues" :key="venue.id" :xs="24" :sm="12" :md="8">
      <VenueCard :venue="venue" @click="(id) => $emit('click', id)" />
    </el-col>
  </el-row>
...
const props = defineProps({
  venues: {
    type: Object,
    required: true,
    default: () => ({ id: 1, name: '飞羽竞技场', type: '篮球场馆', address: '苏州市工业园区独墅湖校区258号', phone: '19552698532', image: '/src/assets/static/im-one.png' }),
    validator: v =>
