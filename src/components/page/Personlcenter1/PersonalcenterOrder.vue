...
const orders = ref([
  { id: 1, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '学会手环', image: 'src/components/Personlcenter1/picture/矩形2(3).png', price: 100.00, quantity: 1, amount: 100.00, status: 'completed' },
  { id: 2, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '学会手环', image: 'src/components/Personlcenter1/picture/矩形2(3).png', price: 100.00, quantity: 1, amount: 100.00, status: 'pending' },
  { id: 3, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '学会手环', image: 'src/components/Personlcenter1/picture/矩形2(3).png', price: 100.00, quantity: 1, amount: 100.00, status: 'cancelled' }
]);
...
.sub-tabs :deep(.el-tabs__item:hover) { color: var(--el-color-primary); }
