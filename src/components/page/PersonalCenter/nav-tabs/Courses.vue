<template>
  <div class="courses">
    <div class="sub-nav">
      <el-button-group>
        <el-button :type="activeSub === 'published' ? 'primary' : 'default'" plain @click="go('courses-published')">我发布的</el-button>
        <el-button :type="activeSub === 'purchased' ? 'primary' : 'default'" plain @click="go('courses-purchased')">我购买的</el-button>
      </el-button-group>
