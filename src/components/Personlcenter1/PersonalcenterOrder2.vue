                ...
                <div v-for="order in orders" :key="order.id" class="order-item">
                  ...
                  <div class="order-item-body">
                    ...
                    <div class="col-actions">
                      ...
                      <el-button v-if="order.status === 'completed'" type="primary" link>再次预约</el-button>
                      <el-button v-if="order.status === 'pending'" type="primary" link>去付款</el-button>
                      <el-button v-if="order.status === 'cancelled'" type="primary" link>重新预约</el-button>
                    </div>
...
const subTab = ref('spaces');
const activeStatus = ref('全部');

const statuses = ref(['全部', '待支付', '已取消', '已完成']);

const orders = ref([
  { id: 1, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '豪华办公室', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?q=80&w=1932&auto=format&fit=crop', price: 100.00, quantity: 1, amount: 100.00, status: 'completed' },
  { id: 2, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '豪华办公室', image: 'https://images.unsplash.com/photo-1521737852583-dc1b49911942?q=80&w=1974&auto=format&fit=crop', price: 100.00, quantity: 1, amount: 100.00, status: 'pending' },
  { id: 3, orderNumber: '12345678912345645891', date: '2025-12-12 20:00', name: '豪华办公室', image: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?q=80&w=2070&auto=format&fit=crop', price: 100.00, quantity: 1, amount: 100.00, status: 'cancelled' }
]);
...
.sub-tabs :deep(.el-tabs__item) {
  ...
  height: 36px;
  border: none !important;
  border-radius: 4px; /* 圆角更小，更紧凑 */
  background-color: #fff; /* 未选中时背景为白色 */
  color: #606266; /* 未选中时文字色 */
  padding: 0 16px;
  margin-right: 8px;
  transition: all 0.2s;
...
.sub-tabs :deep(.el-tabs__item.is-active) {
  ...
  color: #409eff; /* 选中时文字色为主题色 */
  border: 1px solid #409eff; /* 选中时边框为主题色 */
  font-weight: 500;
}
...
/* 状态筛选按钮样式（匹配图片中“全部、待支付、已取消、已完成”的样式） */
.status-filters {
  display: flex;
  gap: 8px;
}
