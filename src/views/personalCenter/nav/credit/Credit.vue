<template>
  <div class="credit">
    ...
    <div class="sub-nav">
      <el-button-group>
        <el-button :type="activeSub === 'details' ? 'primary' : 'default'" plain
          @click="go('credit-details')">学分明细</el-button>
        <el-button :type="activeSub === 'tasks' ? 'primary' : 'default'" plain
          @click="go('credit-tasks')">做任务赚学分</el-button>
      </el-button-group>
    </div>
...
@media (max-width: 768px) {
  .balance-card {
    ...
    grid-template-areas: 'title' 'amount' 'action' 'tips';
  }
