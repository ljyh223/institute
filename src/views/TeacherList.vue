    ...
    <el-header class="header">
      <div class="header-content">
        ...
        <div class="search-section hidden-xs-only">
          <el-input v-model="headerSearch" placeholder="What do you want learn?" :suffix-icon="Search" round />
        </div>
      ...
      <div class="content-container">
        ...
        <el-row :gutter="isMobile ? 20 : 40">
          <el-col v-for="teacher in teachers" :key="teacher.id" :xs="12" :sm="8" :md="6">
            <div class="teacher-card" @click="goTeacherHome(teacher.id)">
        ...
        <div class="pagination-container">
          <el-pagination v-model:current-page="pagination.currentPage" v-model:page-size="pagination.pageSize"
            :page-sizes="[20, 40, 60, 80]" :small="isMobile" :background="true"
